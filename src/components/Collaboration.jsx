    ...
    <Section crosses >
      <div className='container lg:flex' >
        ...
        <div className='lg:ml-auto xl:w-[38rem] mt-8' >
            ...
            <div className='relative left-1/2 w-[22rem] aspect-square border border-n-6 rounded-full -translate-x-1/2 scale-75 md:scale-100 flex justify-center items-center' >
